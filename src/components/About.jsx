          ...
          <div className="flex flex-col items-center justify-between lg:flex-row py-16">
            <div className=" relative ">
              <div className="lg:max-w-xl lg:pr-5 relative z-40">
                ...
                <p className="text-base text-gray-700">
                  At MYShop, we celebrate individuality through unique,
                  high-quality products that help you express your personal
                  style. Our commitment to exceptional service and
                  sustainability ensures that your shopping experience is as
            ...
            <div className="relative hidden lg:ml-32 lg:block lg:w-1/2">
              ...
              <div className="abg-orange-400 mx-auto w-fit overflow-hidden rounded-[6rem] rounded-br-none rounded-tl-none">
                <img src="https://img.labpulse.com/files/base/smg/all/image/2019/09/lp.2019_04_24_17_43_1766_hands_shaking2_400.png?auto=format%2Ccompress&q=70&w=400" />
              </div>
            </div>
          </div>
        </div>
